...
class CRM_Case_Audit_Audit {
  ...
  static
  function run($xmlString, $clientID, $caseID, $printReport = FALSE, $hideActivityTypes = []) {
    /*
...
*/
    ...
    if(!empty($hideActivityTypes)){
      $template->assign('hideActivityTypes', $hideActivityTypes);
    }
